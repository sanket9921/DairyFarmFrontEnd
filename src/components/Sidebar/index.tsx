  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={Logo} width={100} height={100} className='rounded' alt="Logo" />
        </NavLink> 
         <div className='text-white font-bold text-left text-[30px] text-blue-500'>Smart
         <div className='text-white font-bold text-left text-[25px]' >DairyFarm</div>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/addanimal' ||
                            pathname.includes('addanimal')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
